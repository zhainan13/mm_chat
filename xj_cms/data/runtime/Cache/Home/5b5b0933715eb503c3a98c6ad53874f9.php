...
<head>
    <meta charset="UTF-8">
    <title>用户<?php echo ($user_nicename); ?></title>
    <meta http-equiv="Cache-Control" content="no-transform" />
    <meta http-equiv="Cache-Control" content="no-siteapp" />
    <link rel="stylesheet" href="//cdn.bootcss.com/bootstrap/3.3.5/css/bootstrap.min.css" />
    <link rel="stylesheet" href="//cdn.bootcss.com/bootstrap/3.3.5/css/bootstrap-theme.min.css" />
    <link rel="stylesheet" href="/Public/statics/font-awesome-4.4.0/css/font-awesome.min.css" />
    <link rel="stylesheet" href="<?php echo ($public_source); ?>/css/base.css" />
</head>
<body>

<?php if(is_array($alluser)): foreach($alluser as $key=>$vouser): ?><button class="bjy-rong-chat" targetid="<?php echo ($vouser["id"]); ?>" avatar="/data/upload/avatar/<?php echo ($vouser["avatar"]); ?>" targetname="<?php echo ($vouser["user_nicename"]); ?>" style="width: 200px;height: 40px;">点击与用户（<?php echo ($vouser["user_nicename"]); ?>）聊天</button><br/><?php endforeach; endif; ?>
<!-- 聊天框开始 -->
        ...
        <div class="modal-content">
            <div class="bjy-top">
                <div class="bjy-t-myinfo">
                    ...
                    <img class="bjy-t-avatar" src="/data/upload/avatar/<?php echo ($avatar); ?>">
                </div>
...
<script src="<?php echo ($char_file); ?>"></script>
<script>
    var xbIsLogin=1,
        rongUserInfoUrl="<?php echo U('Api/Rong/get_user_info');?>",
        
        saveContentUrl="<?php echo U('Home/Index/save_content');?>",
        
        getlogsUrl="<?php echo U('Home/Index/get_contents');?>",
        
        rongKey="<?php echo ($rong_key); ?>",
        rongToken="<?php echo ($rong_token); ?>",
        xbUserInfo = {
            id: "<?php echo ($id); ?>",
            name: "<?php echo ($user_nicename); ?>",
            avatar: "/data/upload/avatar/<?php echo ($avatar); ?>"
        };
    // 下面的代码是用来测试的
...
<script src="/public/statics/emoji/js/config.js"></script>
<script src="/public/statics/emoji/js/emoji-picker.js"></script>
<script src="/public/statics/emoji/js/jquery.emojiarea.js"></script>
...
<script src="/public/statics/rongcloud/js/main.js"></script>
<script src="<?php echo ($public_source); ?>/js/base.js"></script>
<script>
$(function(){
    // 初始化emoji
